...
import com.mojang.serialization.Dynamic; //import com.mojang.datafixers.Dynamic;

public class AmethystOreFeature extends OreFeature {

    public AmethystOreFeature(Codec<OreFeatureConfig> function_1) {
        super((Codec<OreFeatureConfig>) function_1); //super(function_1);
    }

    //<? extends FlatChunkGeneratorConfig>
    public boolean generate(ServerWorldAccess iWorld_1, StructureAccessor accessor, ChunkGenerator chunkGenerator_1,
                                Random random_1, BlockPos blockPos_1, OreFeatureConfig oreFeatureConfig_1) {
        if (random_1.nextInt(5) == 0) {
            return super.generate(iWorld_1, accessor, chunkGenerator_1, random_1, blockPos_1, oreFeatureConfig_1);
        } else {
            return false;
        }
    }
    ...
    //@Override
    protected boolean generateVeinPart(ServerWorldAccess iWorld_1, Random random_1, OreFeatureConfig oreFeatureConfig_1,
                                   double double_1, double double_2, double double_3, double double_4, double double_5, double double_6,
                                   int int_1, int int_2, int int_3, int int_4, int int_5) {
                            ...
                            if (double_20 * double_20 + double_21 * double_21 < 1.0D) {
                                for (int int_19 = int_13; int_19 <= int_16; ++int_19) {
                                    ...
                                    if (double_20 * double_20 + double_21 * double_21 + double_22 * double_22 < 1.0D) {
                                        int int_20 = int_17 - int_1 + (int_18 - int_2) * int_4
                                                + (int_19 - int_3) * int_4 * int_5;
                                        if (!bitSet_1.get(int_20)) {
                                            bitSet_1.set(int_20);
                                            blockPos$Mutable_1.set(int_17, int_18, int_19);
                                            if (oreFeatureConfig_1.target.getCondition()
                                                    .test(iWorld_1.getBlockState(blockPos$Mutable_1))) {
